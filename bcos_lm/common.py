...
class BcosUtilMixin:
    ...
    def explain_lm(
        ...
        **grad2img_kwargs,
        ...
        ## TODO: input as tokens or raw text, tokenization happens within the method; batch operation
        """
        ...
        """
        if in_tensor.ndim != 3:
            raise ValueError("Expected 3-dimensional input tensor")
        if in_tensor.shape[0] != 1:  ## TODO: why not batch?
        ...
        result["contribution_map"] = (in_tensor * in_tensor.grad).sum(-1) # sum over dim -1?
