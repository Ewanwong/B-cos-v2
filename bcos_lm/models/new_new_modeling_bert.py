# This is the bcosified version of the original transformers.models.bert.modeling_bert.py
...
class BertEncoder(nn.Module):
    def __init__(self, config):
        ...
        if hasattr(config, "bcos") and config.bcos and hasattr(config, "different_b_per_layer") and config.different_b_per_layer and hasattr(config, "b_list") and config.b_list is not None:
            ...
            self.layer = nn.ModuleList([BertLayer(config_list[i]) for i in range(config.num_hidden_layers)])
        else:
