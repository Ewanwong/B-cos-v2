...
class BertPreTrainedModel(BcosUtilMixin, PreTrainedModel):
    ...
    ## bcos
    @classmethod
    def load_from_pretrained(cls, model_name_or_path, config=None):
        if not hasattr(config, "bcos") or not config.bcos:
            ...
            conventional_model = cls.load_from_pretrained(model_name_or_path, config=conventional_config)
