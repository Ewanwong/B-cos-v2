...
def visualize_human_explanation(attribution_result, evidence, orig_text, tokenizer):
    ...
    for evidence_span in evidence:
        span_ids = tokenizer.encode(evidence_span, add_special_tokens=False, max_length=512, truncation=True)
...
if __name__ == "__main__":
    ...
    human_percentage = visualize_human_explanation(correct_attribution_results[idx], correct_evidences[idx], dataset['text'][idx], tokenizer)
